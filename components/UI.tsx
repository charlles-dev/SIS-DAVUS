...
export const Dialog: React.FC<DialogProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="z-50 w-full max-w-lg scale-100 gap-4 border bg-white p-6 opacity-100 shadow-lg sm:rounded-lg md:w-full max-h-[90vh] overflow-y-auto m-4 dark:bg-gray-800 dark:border-gray-700">
...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <div className="fixed inset-0 bg-black/50 transition-opacity backdrop-blur-sm" onClick={onClose} />
      <div className="z-50 w-full max-w-sm scale-100 gap-4 border bg-white p-6 opacity-100 shadow-lg rounded-lg m-4 dark:bg-gray-800 dark:border-gray-700">
...
export const Dropdown: React.FC<DropdownProps> = ({ trigger, children }) => {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md border border-gray-200 bg-white shadow-md focus:outline-none animate-in fade-in-0 zoom-in-95 dark:bg-gray-800 dark:border-gray-700">
...
export const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, children, ...props }) => (
  <div className={cn("rounded-xl border border-gray-100 bg-white text-davus-dark shadow-soft hover:shadow-lg transition-all duration-300 dark:bg-gray-900/50 dark:border-gray-800 dark:text-gray-100 backdrop-blur-sm", className)} {...props}>
    {children}
  </div>
);
